...
public class MLNParser extends Parser {
    ...
    public final definitions_return definitions() throws RecognitionException {
        definitions_return retval = new definitions_return();
        retval.start = input.LT(1);
        int definitions_StartIndex = input.index();
        Object root_0 = null;

        Token EOF3=null;
        schemaList_return schemaList1 = null;

        ruleList_return ruleList2 = null;
    ...
    public final schemaList_return schemaList() throws RecognitionException {
        schemaList_return retval = new schemaList_return();
        retval.start = input.LT(1);
        int schemaList_StartIndex = input.index();
        Object root_0 = null;

        schema_return schema4 = null;

        schemaConstraint_return schemaConstraint5 = null;
    ...
    public final schema_return schema() throws RecognitionException {
        schema_return retval = new schema_return();
        retval.start = input.LT(1);
    ...
    public final predArg_return predArg() throws RecognitionException {
        predArg_return retval = new predArg_return();
        retval.start = input.LT(1);
    ...
    public final schemaConstraint_return schemaConstraint() throws RecognitionException {
        schemaConstraint_return retval = new schemaConstraint_return();
        retval.start = input.LT(1);
        int schemaConstraint_StartIndex = input.index();
        Object root_0 = null;

        functionalDependency_return functionalDependency9 = null;
    ...
    public final functionalDependency_return functionalDependency() throws RecognitionException {
        functionalDependency_return retval = new functionalDependency_return();
        retval.start = input.LT(1);
        ...
        functionalDependencyItem_return functionalDependencyItem12 = null;

        functionalDependencyItem_return functionalDependencyItem14 = null;
    ...
    public final functionalDependencyItem_return functionalDependencyItem() throws RecognitionException {
        functionalDependencyItem_return retval = new functionalDependencyItem_return();
        retval.start = input.LT(1);
    ...
    public final ruleList_return ruleList() throws RecognitionException {
        ruleList_return retval = new ruleList_return();
        retval.start = input.LT(1);
        int ruleList_StartIndex = input.index();
        Object root_0 = null;

        mlnRule_return mlnRule17 = null;

        scopingRule_return scopingRule18 = null;

        datalogRule_return datalogRule19 = null;
    ...
    public final mlnRule_return mlnRule() throws RecognitionException {
        mlnRule_return retval = new mlnRule_return();
        retval.start = input.LT(1);
        ...
        Token tag=null;
        Token STRING20=null;
        softRule_return softRule21 = null;

        hardRule_return hardRule22 = null;
    ...
    public final softRule_return softRule() throws RecognitionException {
        softRule_return retval = new softRule_return();
        retval.start = input.LT(1);
    ...
    public final hardRule_return hardRule() throws RecognitionException {
        hardRule_return retval = new hardRule_return();
        retval.start = input.LT(1);
    ...
    public final functionalAtom_return functionalAtom() throws RecognitionException {
        functionalAtom_return retval = new functionalAtom_return();
        retval.start = input.LT(1);
    ...
    public final datalogRule_return datalogRule() throws RecognitionException {
        datalogRule_return retval = new datalogRule_return();
        retval.start = input.LT(1);
        ...
        Token PERIOD34=null;
        literal_return head = null;

        literal_return body0 = null;

        literal_return bodyp = null;

        mathComparison_return mc = null;

        boolExpression_return be = null;
    ...
    public final scopingRule_return scopingRule() throws RecognitionException {
        scopingRule_return retval = new scopingRule_return();
        retval.start = input.LT(1);
    ...
    // MLN.g:339:1: foclause returns [MLNClause c = new MLNClause()] : (exq= existQuan )? (ant0= literal ( ',' antp= literal )* ( ',' mc= mathComparison )* ( ',' '[' be= boolExpression ']' )? IMPLIES )? lit0= literal ( 'v' litp= literal )* ( 'v' mc= mathComparison )* ( 'v' '[' sbe= boolExpression ']' )? ;
    public final foclause_return foclause() throws RecognitionException {
        foclause_return retval = new foclause_return();
        retval.start = input.LT(1);
        ...
        existQuan_return exq = null;

        literal_return ant0 = null;

        literal_return antp = null;

        mathComparison_return mc = null;

        boolExpression_return be = null;

        literal_return lit0 = null;

        literal_return litp = null;

        boolExpression_return sbe = null;
    ...
    public final existQuan_return existQuan() throws RecognitionException {
        existQuan_return retval = new existQuan_return();
        retval.start = input.LT(1);
    ...
    public final boolExpression_return boolExpression() throws RecognitionException {
        ...
        Token set59=null;
        boolConjunction_return c0 = null;

        boolConjunction_return cp = null;
    ...
    public final boolConjunction_return boolConjunction() throws RecognitionException {
        boolConjunction_return retval = new boolConjunction_return();
        retval.start = input.LT(1);
        int boolConjunction_StartIndex = input.index();
        Object root_0 = null;

        Token set60=null;
        boolConjunctionElement_return c0 = null;

        boolConjunctionElement_return cp = null;
    ...
    public final boolConjunctionElement_return boolConjunctionElement() throws RecognitionException {
        boolConjunctionElement_return retval = new boolConjunctionElement_return();
        retval.start = input.LT(1);
        ...
        funcExpression_return fe = null;

        boolExpression_return b = null;
    ...
    public final mathComparison_return mathComparison() throws RecognitionException {
        mathComparison_return retval = new mathComparison_return();
        retval.start = input.LT(1);
        int mathComparison_StartIndex = input.index();
        Object root_0 = null;

        Token op=null;
        mathExpression_return e1 = null;

        mathExpression_return e2 = null;
    ...
    public final mathExpression_return mathExpression() throws RecognitionException {
        mathExpression_return retval = new mathExpression_return();
        retval.start = input.LT(1);
        int mathExpression_StartIndex = input.index();
        Object root_0 = null;

        Token op=null;
        mathTerm_return t0 = null;

        mathTerm_return tp = null;
    ...
    public final mathTerm_return mathTerm() throws RecognitionException {
        mathTerm_return retval = new mathTerm_return();
        retval.start = input.LT(1);
        int mathTerm_StartIndex = input.index();
        Object root_0 = null;

        Token op=null;
        mathFactor_return t0 = null;

        mathFactor_return tp = null;
    ...
    public final mathFactor_return mathFactor() throws RecognitionException {
        mathFactor_return retval = new mathFactor_return();
        retval.start = input.LT(1);
        ...
        atomicExpression_return ae = null;

        mathExpression_return ee = null;

        mathFactor_return mf = null;
    ...
    public final funcExpression_return funcExpression() throws RecognitionException {
        funcExpression_return retval = new funcExpression_return();
        retval.start = input.LT(1);
        ...
        funcArgument_return a0 = null;

        funcArgument_return ap = null;
    ...
    public final funcArgument_return funcArgument() throws RecognitionException {
        funcArgument_return retval = new funcArgument_return();
        retval.start = input.LT(1);
    ...
    public final atomicExpression_return atomicExpression() throws RecognitionException {
        atomicExpression_return retval = new atomicExpression_return();
        retval.start = input.LT(1);
    ...
    public final queryList_return queryList() throws RecognitionException {
        queryList_return retval = new queryList_return();
        retval.start = input.LT(1);
        int queryList_StartIndex = input.index();
        Object root_0 = null;

        Token EOF75=null;
        query_return query74 = null;
    ...
    public final queryCommaList_return queryCommaList() throws RecognitionException {
        queryCommaList_return retval = new queryCommaList_return();
        retval.start = input.LT(1);
        ...
        Token EOF81=null;
        query_return query78 = null;

        query_return query80 = null;
    ...
    public final evidenceList_return evidenceList() throws RecognitionException {
        evidenceList_return retval = new evidenceList_return();
        retval.start = input.LT(1);
        int evidenceList_StartIndex = input.index();
        Object root_0 = null;

        Token EOF83=null;
        evidence_return evidence82 = null;
    ...
    public final evidence_return evidence() throws RecognitionException {
        evidence_return retval = new evidence_return();
        retval.start = input.LT(1);
