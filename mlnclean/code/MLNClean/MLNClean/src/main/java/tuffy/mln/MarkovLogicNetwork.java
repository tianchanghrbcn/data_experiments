...
public class MarkovLogicNetwork implements Cloneable{
	 ...
	 */
	public Hashtable<String, Type> nameMapType =
	...
	/**
	 * Map from signature of clauses to MLNClause object.
...
//		clone.mapConstantID = (HashMap<String, Integer>) mapConstantID.clone();
	 ...
	 * MLNClause$id. Predicates in this clause is registered
